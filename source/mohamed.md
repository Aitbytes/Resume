...
- <u>**Infrastructure**</u>: <span class="mastered">Kubernetes, Docker, Terraform, Linux, Git, Jenkins, GitLab</span>, <span class="ammateur">Ansible, Packer, AWS (CL-C02)</span>
- <u>**Sécurité & IAM**</u>: <span class="mastered">HashiCorp Vault, OpenBao, Checkmarx (SAST/SCA), SonarQube, TruffleHog</span>, <span class="ammateur">OAuth/OIDC/SAML, IAM AWS</span>
...
<span class="sous-intitule">**Consultant DevSecOps - Expert Sécurité**</span>
...
#### Consultant DevSecOps - Expert Sécurité — EDF Direction Commerce  <time>Avril 2026 - Présent</time>
- Intégré à l'équipe **DevSecOps** de la Direction Commerce d'**EDF** en tant qu'**expert sécurité** : animation de la communauté des security champions et support transverse sur l'outillage.
- **Ateliers mensuels** regroupant les security champions des équipes (vulgarisation, bonnes pratiques, veille, retours d'expérience).
- **Support outillage DevSecOps** : accompagnement des équipes sur **Jenkins, Checkmarx SAST/SCA, GitLab, SonarQube, OpenBao, TruffleHog**.
- **Amélioration continue** : participation au développement de l'outillage interne et **remontée structurée de besoins** aux équipes plateformes.

#### Consultant SecDevOps — Airbus OneTrust  <time>Octobre 2025 - Avril 2026</time>
...
- **Création d'une "Golden Image" immuable** avec **Packer**, **Terraform** et **Ansible** (bootstrapping d'un écosystème GitOps).
